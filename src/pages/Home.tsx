									...
									<div className="col-lg-8 col-xl-7 col-xxl-6">
										<div className="my-5 text-center text-xl-start">
											<h1 className="display-5 fw-bolder text-white mb-2">
												Bike Services with Bootstrap, TypeScript & Vite
											</h1>
											<p className="lead fw-normal text-white-50 mb-4">
												Join our fast growing community of bike riders across
												the world!
											</p>
									...
									<div className="card h-100 shadow border-0">
										...
										<div className="card-body p-4">
											...
											<a
												...
												href="#!"
											>
												<h5 className="card-title mb-3">Bike News</h5>
											</a>
											<p className="card-text mb-0">
												Catch up with latest news in MTB.
											</p>
										</div>
								...
								<div className="col-lg-4 mb-5">
									<div className="card h-100 shadow border-0">
										...
										<div className="card-body p-4">
											...
											<p className="card-text mb-0">
												Reach our community with a finger tip in no time.
											</p>
										</div>
										<div className="card-footer p-4 pt-0 bg-transparent border-top-0">
											<div className="d-flex align-items-end justify-content-between">
								...
								<div className="col-lg-4 mb-5">
									<div className="card h-100 shadow border-0">
										...
										<div className="card-body p-4">
											...
											>
												<h5 className="card-title mb-3">
													Group traveling across the world!
												</h5>
											</a>
											<p className="card-text mb-0">
												Sing up to see our next planning trip.
											</p>
										</div>
										<div className="card-footer p-4 pt-0 bg-transparent border-top-0">
											<div className="d-flex align-items-end justify-content-between">
